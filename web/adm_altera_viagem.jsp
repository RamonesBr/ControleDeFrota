                                            ...
                                            <div class="modal-dialog">      
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">Selecione um veículo</h4>
                                                    </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="data-table" class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class=" "><input type="radio" required name="boxIdVeic" value="<%=veiculo2.get(i).getId()%>" </td>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="acao" value="AlteraVeicAdm" class="btn btn btn-primary" data-submit="modal">Salvar Alterações</button>
                                                    </div>
