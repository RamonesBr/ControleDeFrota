...
<%
    List<Funcionario> f = Auxiliar.todosFuncionarios();
%>
        ...
        <main class="main">                                                                                     
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <small>Gerencie os Funcionarios ...</small>
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><%=f.get(i).getCpf()%> </td>
                                        <td><%=f.get(i).getNome()%> </td>
                                        <td><%=f.get(i).getDepartamento()%></td>
                                        <td><%=f.get(i).getLogin()%></td>
                                        <td><%=f.get(i).getTipo()%></td> 
                                        <td><%=f.get(i).getStatus()%></td>
                                        <td><%=f.get(i).getEmail()%></td>
                                        
                                        
                                        <td>  <form action="ControleFuncionario" method="POST">  <input type="hidden" value="<%=f.get(i).getId()%>" name="txtId">
                                              <button type="submit" name="acao" value="Excluir" onclick="return confirm('Deseja realmente exluir ? Lembre-se que caso o funcionario seja responsavel por algum veiculo, mesmo devera ser atribuido para outro funcionario antes da exclusao')"  class="btn btn-dark btn--icon">  <i class="zmdi zmdi-delete zmdi-hc-fw"></i> </button>  </form>
                                            
                                              <form action="ControleFuncionario" method="POST">  <input type="hidden" value="<%=f.get(i).getId()%>" name="txtId">
                                              <button type="submit" name="acao" value="FuncEdit"  class="btn btn-dark btn--icon">  <i class="zmdi zmdi-edit zmdi-hc-fw"></i> </button> </form>
