                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-body__title">Cadastre um Funcionario</h3>
                                <form action="ControleFuncionario" method="POST" >
                                    <div class="row">

                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" required="" class="form-control"  name="txtCpf"   placeholder="CPF (Somente numeros)">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" required="" class="form-control" placeholder="CNH (Somente numeros)"name="txtCnh">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="text" required="" class="form-control" placeholder="NOME" name="txtNome">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="date" required="" class="form-control" placeholder="Data_Nasc" name="txtData_Nasc">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <select class="form-control" name="txtDepartamento" placeholder="Tipo">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="email" required="" class="form-control" placeholder="EMAIL" name="txtEmail">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="text" required="" class="form-control" placeholder="LOGIN" name="txtLogin">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="password" required="" class="form-control" placeholder="SENHA" name="txtSenha">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
