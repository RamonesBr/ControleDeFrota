...
<%
            ...
            List<Viagem> v = Auxiliar.todasViagensAdmComum(funcionarioAutenticado);
                            ...
                            <table id="data-table" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><form action="ControleViagem" method="POST">  <input type="hidden" value="<%=v.get(i).getId()%>" name="txtId"><input type="hidden" value="<%=funcionarioAutenticado.getTipo()%>" name="txtTipo_func">
                                                <button type="submit" name="acao" value="ConsultaViagemPorId"  class="btn btn-dark btn--icon">  <i class="zmdi zmdi-eye zmdi-hc-fw"></i> </button>  </form>

                                            <form action="ControleViagem" method="POST">  <input type="hidden" value="<%=v.get(i).getId()%>" name="txtIdViagem"><input type="hidden" value="<%=funcionarioAutenticado.getTipo()%>" name="txtTipo_func">
                                                <button type="submit" name="acao" value="CancelaViagem"  onclick="return confirm('Deseja realmente EXCLUIR a viagem?')" class="btn btn-dark btn--icon">  <i class="zmdi zmdi-close-circle zmdi-hc-fw"></i> </button> 
                                                <input type="text" hidden name="txtIdVeic" value="<%=v.get(i).getVeiculo().getId()%>"><input type="text" hidden name="txtUsuario_cancelador" value="<%=funcionarioAutenticado.getLogin()%>">
                                            </form>
                                        </td>
                                    </tr>
