                                    ...
                                    <tr>
                                       ...
                                       <td>
                                            <form action="ControleViagem" method="POST">  <input type="hidden" value="<%=v.get(i).getId()%>" name="txtIdViagem"> <input type="hidden" value="<%=funcionarioAutenticado.getTipo()%>" name="txtTipo_func">
                                                <button type="submit" name="acao" value="AlteraStatusLiberado"  onclick="return confirm('Deseja realmente LIBERAR a viagem?')" class="btn btn-dark btn--icon">  <i class="zmdi zmdi-thumb-up zmdi-hc-fw"></i> </button> 
                                                <input type="text" hidden name="txtAdm_aprovador" value="<%=funcionarioAutenticado.getLogin()%>">
                                            </form>
                                        </td>
                                    </tr>
