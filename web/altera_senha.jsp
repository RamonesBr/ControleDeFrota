                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-body__title">Troque sua senha</h3>
                                <form action="ControleFuncionario" method="POST" >
                                    <div class="row">

                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="password" required="" class="form-control"  name="txtSenhaAtual"   placeholder="Senha Atual">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="password" required="" class="form-control" placeholder="Nova Senha"name="txtNovaSenha">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="password" required="" class="form-control" placeholder="Repita a senha" name="txtConfirmaSenha">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>

                                        <input type="hidden" name="txtSenha" value="<%=funcionarioAutenticado.getSenha()%>">


                                        <input type="hidden" name="txtId" value="<%=funcionarioAutenticado.getId()%>" >


                                    </div>

                                    <div>
                                        <input type="submit" value="TrocaSenha" class="btn btn-outline-primary" name="acao" />
                                    </div>
                                </form>
                                <script>
                                    <%
