...
<%
    List<Veiculo> v = Auxiliar.todosVeiculos();
%>
           ...
           <header class="header">
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <small>Gerencie seus veiculos ...</small>
                            ...
                            <table id="data-table" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=v.get(i).getGrupo()%> </td>
                                        <td><%=v.get(i).getResponsavel().getNome()%> </td>
                                        <td><%=v.get(i).getData_tr_oleo()%></td>
                                        <td><%=v.get(i).getData_manut()%></td>
                                        <td><%=v.get(i).getStatus()%></td>
                                        <td><form action="ControleVeiculo" method="POST">  <input type="hidden" value="<%=v.get(i).getId()%>" name="txtId">
                                              <button type="submit" name="acao" value="Excluir" onclick="return confirm('Deseja mesmo excluir ese veículo ?')"  class="btn btn-dark btn--icon">  <i class="zmdi zmdi-delete zmdi-hc-fw"></i> </button>  </form>
                                            
                                              <form action="ControleVeiculo" method="POST">  <input type="hidden" value="<%=v.get(i).getId()%>" name="txtId">
                                              <button type="submit" name="acao" value="buscaVeicEdit"  class="btn btn-dark btn--icon">  <i class="zmdi zmdi-edit zmdi-hc-fw"></i> </button> </form>
                                        </td>
                                    </tr>
