        ...
        <div class="login">
            ...
            <div class="login__block active" id="l-login" >
                <div class="login__block__header">
                    ...
                    Olá ! Bem-vindo ao sistema de frotas da Vepan
                ...
                <form action="ControleAcesso" method="POST">
                    <div class="login__block__body">
                        <div class="form-group">
                            <input type="text" class="form-control text-center" placeholder="Informe o Login" name="txtLogin">
                        </div>

                        <div class="form-group">
                            <input type="password" class="form-control text-center" placeholder="Senha" name="txtSenha">
                        </div>
                        <input type="submit" value="Entrar" name="acao" class="btn btn-outline-primary">
