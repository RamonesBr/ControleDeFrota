...
<%
            ...
            List<Veiculo> v = Auxiliar.veiculosManutencaoPorDepto(funcionarioAutenticado);
                            ...
                            <table id="data-table" class="table">
                                <thead>
                                    <tr>
                                        <th>Placa</th> 
                                        <th>Modelo</th>
                                        <th>Ultima troca de oleo</th>
                                        <th>Ultima manutenção</th>
                                        <th>Requisitar Manutenção</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="submit" class="btn btn-dark btn--icon" data-toggle="modal" data-target="#ModalMotivo<%=i%>">
                                                <i class="zmdi zmdi- zmdi-local-car-wash zmdi-hc-fw"></i> </button> </td>
                                    </tr>
                                    
                                    
                                    <div id="ModalMotivo<%=i%>" class="modal fade" role="dialog">
                                        ...
                                        <div class="modal-content">
                                            <form action="ControleVeiculo" method="POST">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">INFORME O MOTIVO DA MANUTENÇÃO</h4>
                                                </div>
                                                <div class="modal-body">

                                                    
                                                    
                                                    <input type="text" required="" hidden class="form-control"  name="txtNome"value="<%=funcionarioAutenticado.getNome()%>">
                                                    <input type="text" required="" hidden class="form-control"  name="txtPlaca"value="<%=v.get(i).getPlaca()%>">
                                                    <input type="text" required="" hidden class="form-control"  name="txtModelo"value="<%=v.get(i).getModelo()%>">
                                                    

                                                    <div class="form-group">
                                                        <textarea class="form-control" rows="5" placeholder="Informe aqui o motivo da manutenção" name="txtMotivo"></textarea>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="acao" value="ReqManut" class="btn btn btn-primary" data-submit="modal">Enviar Solicitação</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
