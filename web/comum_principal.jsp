           ...
           <header class="header">
            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                        <li class="navigation__active"><a href="comum_principal.jsp"><i class="zmdi zmdi-home"></i> Home</a></li>
                        <li class="navigation__active"><a href="comum_minhas_viagens.jsp"><i class="zmdi zmdi-navigation"></i>Minhas Viagens</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" readonly="" required="" class="form-control" name="txtFunc" value="<%=funcionarioAutenticado.getNome()%>">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
