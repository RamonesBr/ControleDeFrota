                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-body__title">Cadastro de Veiculos</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Renavam</label>
                                                <input type="number" required="" class="form-control"  name="txtRenavam"   placeholder="Renavam (Somente numeros)">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Placa</label>
                                                <input type="text" required="" class="form-control" placeholder="Placa"name="txtPlaca">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Marca</label>
                                                <input type="text" required="" class="form-control" placeholder="Marca" name="txtMarca">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" required="" class="form-control" placeholder="KM da troca de oleo"  name="txtKm_tr_oleo">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" required="" class="form-control"  name="txtOleo">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" required="" class="form-control"  name="txtRevisao">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Ano</label>
                                                <input type="number" required="" class="form-control" placeholder="Ano (somente numeros)" name="txtAno">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Modelo</label>
                                                <input type="text" required="" class="form-control" placeholder="Modelo" name="txtModelo">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Grupo</label>
                                                <select class="form-control" name="txtGrupo" placeholder="Tipo">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" required="" class="form-control" placeholder="Km Veiculo (somente numeros)" name="txtKm_veic">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
